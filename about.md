...
Bir programlama dilinin otomatik olarak uluslararası bir iletişim aracı haline gelmesi gerçekten çok güzel birşey. Yani insanlar konuşurken ya da yazarken yanlış anlaşılabilirler ama bir program yazdığınızda program ya çalışır ya da çalışmaz. Kendini, işlemciye doğru ifade etmelisin. Purebasic ile kendini işlemciye hızlı ve kolay bir şekilde ifade edebilirsin.
