...
```
<br>
Arduino IDE'de Araçlar ➡️ Seri Port Ekranı menüsünden, aşağıdaki pencereyi açıyoruz. Arduino'ya 1 yollarsak led yanacak, 0 yollarsak sönecektir. Arduino bize, bilgiyi aldığını teyit eden bir cevap da yolayacaktır.<br><br>
