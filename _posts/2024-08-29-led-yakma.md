...
Purebasic ile hazırlayacağımız, arayüz veya kullanıcı formu ile Arduino'yu kontrol edeceğiz. Bir tane ucuzundan [Arduino Uno](https://robolinkmarket.com/arduino-uno-r3-smd-klon) alıp, bu dili öğrenmek daha faydalı ve eğlenceli olacaktır.<br><br>
Linkteki klon Arduino'yu aldıysan [CH340](https://akademi.robolinkmarket.com/ch340-driver-kurulumu) sürücü kurulumunu da yapman gerekiyor.<br><br>
PC ile Arduino arasında haberleşme için (seri bağlantı) Arduino'nun kendi usb kablosunu kullanacağız. Kablo dışında bir LED ve 220 ohm ile 1K arası bir dirence ihtiyaç olacak. Benim gibi yazılıma merak sarmış elektronikçilerin yanısıra elektroniğe merak sarmış yazılımcılar da bu yazıyı okuyabilir. O yüzden breadboard'dan biraz bahsedeyim. Breadboard üzerinde bulunan her 5 delik kısa devredir, malzemeleri birbirine bağlamak için kullanılır. Şemadaki gibi bağlantı yaparsan devre çalışmayacaktır. Arduino GND'den gelen kablo, direncin girdiği 5 delikten birine girmelidir. Ayrıca LED'i ters bağlarsanız yanmaz. Evet, bu şema için breadboard'a gerek yok ama başka şemalarda ihtiyacın olabilir.
