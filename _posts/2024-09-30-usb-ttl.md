...
Klon Arduino sahibiysen, kart üzerindeki usb-seri çevirici, [CH340](https://akademi.robolinkmarket.com/ch340-driver-kurulumu) entegresidir. Arduino'yu devre dışı bırakıp, sadece kart üzerindeki usb-seri çeviriciyi kullanmak için Arduino RESET pinini GND'a bağlıyoruz. Peki neden TX'i TX'e, RX'i RX'e bağladık ? Seri bağlantılar, normalde TX➡️RX ve RX➡️TX şeklinde bağlanır. TX sinyali gönderen pin, RX ise alan pindir. Bu durumu, Arduino ile PIC16F886'ya program atan arkadaş, [videosunda](https://www.youtube.com/watch?v=qOztsbEfg1g) gayet güzel anlatmış. CH340'ın TX sinyali ATMEGA'nın
