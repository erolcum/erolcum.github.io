...
<br>
PB'in güzelliği de şu ki .Net veya Java gibi başka bir kütüphaneye bağlı olmadan tamamen kendi kendine çalışıyor olmasıdır. Yukarıdaki kodları alın, PB editörüne yapıştırın. Program çalışacaktır.
