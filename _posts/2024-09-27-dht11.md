...
<br><br>
Bu grafiği almak için haliyle sensöre hohlamam gerekti biraz  😄 Siteyi, About sekmesinden başlayarak okuyun. Yazıları da sırayla okuyun. Aksi halde önceki yazılarda belirttiğim püf noktaları kaçırmış olursun.<br>
...
<br><br>
PB'in güzelliği de şu ki .Net veya Java gibi başka bir kütüphaneye bağımlı olarak değil tamamen kendi kendine çalışıyor olmasıdır. Yukarıdaki kodları alın, PB editörüne yapıştırın. Program çalışacaktır. <br><br>
PB'in bir başka güzelliği de thread konusunun sade ve anlaşılır olmasıdır. Örneğin bu işi .Net ile yapsaydık, seri porttan gelen bilginin grafiğe veya forma aktarılması için Delegate, Invoke gibi komutlar kullanmak gerekecekti. .Net için thread konusunu araştırırsan, çok karmaşık ve zor olduğunu görürsün. PB'de ise çok çok daha kolay ve anlaşılır..
