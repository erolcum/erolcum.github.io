...
<br><br>
PB'in güzelliği de şu ki, programın, .Net veya Java'da olduğu gibi başka bir kütüphaneye bağımlı olarak değil tamamen kendi kendine çalışıyor olmasıdır. Yukarıdaki kodları alın, PB editörüne yapıştırın. Program çalışacaktır. İşletim sistemi Windows 7, 8, 9, 10, 11 olsa da bu kod hepsinde çalışır. <br><br>
