...
Arduino'dan gelen sıcaklık ve nem bilgisini grafiksel (chart) olarak gösteriyoruz. Merak etmeyin, aşağıdaki 3 tane .pb uzantılı dosyanın toplam satır sayısı, demo PB editörünün limiti olan 800 satırı geçmiyor.<br><br>
