...
```
<br>
Bu kodu Arduino'ya yükledikten sonra, her 250 milisaniyede bir sıcaklık ve nem bilgisi TP24@55 biçiminde Purebasic'e iletilecektir. Forumda dolanırken resimde olduğu gibi sinüs, cosinüs veya başka matematiksel grafikleri zamana bağlı olarak çizebilen bir kod parçası buldum. graph100 isimli forum kullanıcısı yazmış, sanırım fransız kendisi. <br><br>
